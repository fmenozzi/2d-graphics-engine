...
struct GTestStats {
    ...
    template <typename T> void expectEQ(T a, T b, const char* msg) {
        this->expectTrue(a == b, msg);
    }
    
    template <typename T> void expectNE(T a, T b, const char* msg) {
        this->expectTrue(a != b, msg);
    }

    void expectNULL(const void* ptr, const char* msg) {
        this->expectTrue(NULL == ptr, msg);
    }
    
    void expectPtr(const void* ptr, const char* msg) {
        this->expectTrue(NULL != ptr, msg);
    }

    void expectFalse(bool pred, const char* msg) {
        this->expectTrue(!pred, msg);
    }
    
    void expectTrue(bool pred, const char* msg) {
